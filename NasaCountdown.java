...
public class NasaCountdown {
	public static void main(String[] args) {
		...
		String potato =JOptionPane.showInputDialog(null, "Start countdown from 10 to 0!");
		// 3. convert the user's answer to an int (Integer.parseInt)
       int potatoAsInt = Integer.parseInt(potato);
		                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               
		// 4. countdown from user's starting point
        
		// 1. countdown from 10 to 0
        for (int i = potatoAsInt; i >= 0; i=i - 1) {
...
static void speak(String words) {
   	 try {
   		 Runtime.getRuntime().exec("BLASTOFF " + words).waitFor();
   	 } catch (Exception e) {
   		 e.printStackTrace();
   	 }
  }
